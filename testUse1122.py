...
MODEL_DIR='E:\MissZhou\虹膜\1108ubuntu\model'
MODEL_FILE='classify_image_graph_def.pb'
CACHE_DIR='E:\MissZhou\虹膜\1108ubuntu\tmp\bottleneck'
INPUT_DATA='E:\MissZhou\虹膜\1108ubuntu\pic'
...
def main(_):
	...
	with tf.Session() as sess:
		#sess.run(init)
		saver.restore(sess,".\model1122\net1121.ckpt")
		print("------light--------")
		test_bottlenecks=get_random_cached_bottlenecks(sess,"E:\MissZhou\虹膜\1108ubuntu\test\light1.jpg",jpeg_data_tensor,bottleneck_tensor)		
